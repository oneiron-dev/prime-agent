...
/** A successful foreground process accepts its action; a failed one rejects it. */
export type ActionState = "QUEUED" | "READY" | "RUNNING" | "UNCERTAIN" | "ACCEPTED" | "REJECTED" | "SUPERSEDED";
